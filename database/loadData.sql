...
INSERT INTO Voluntario (nombre, email, password, rut, ubicacion_voluntario) VALUES ('Andrea Juárez', 'andrea.juarez@example.com', 'pass123', '12345678-9', ST_GeomFromText('POINT(-70.72326024012591 -33.475460477185464)', 4326)); --SANTIAGO
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Luis Navarro', 'luis.navarro@example.com', 'pass456', '23456789-0',ST_GeomFromText('POINT(-70.72413394422644 -33.47538868364822)', 4326));
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Carla Espinoza', 'carla.espinoza@example.com', 'pass789', '14567890-1',ST_GeomFromText('POINT(-72.23595293617713 -39.295751618022386)', 4326));--VILLARICA
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Marco Antonio', 'marco.antonio@example.com', 'pass012', '15678901-2',ST_GeomFromText('POINT(-72.23591193023263 -39.295938693967116)', 4326));
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Ximena Soto', 'ximena.soto@example.com', 'pass345', '16789012-3',ST_GeomFromText('POINT(-72.23591193023263 -39.295938693967116)', 4326));
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Diego Morales', 'diego.morales@example.com', 'pass678', '17890123-4',ST_GeomFromText('POINT(-72.23642324842609 -39.29429961138347)', 4326));
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Rosa Campos', 'rosa.campos@example.com', 'pass901', '18901234-5',ST_GeomFromText('POINT(-72.23594449904962 -39.294483889806955)', 4326));
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Javier López', 'javier.lopez@example.com', 'pass234', '19012345-6',ST_GeomFromText('POINT(-72.23546478607034 -39.29408053252056)', 4326));
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Mónica Gutiérrez', 'monica.gutierrez@example.com', 'pass567', '20123456-7',ST_GeomFromText('POINT(-72.23887361702606 -39.29572248782302)', 4326));
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Esteban Rojas', 'esteban.rojas@example.com', 'pass890', '21234567-8',ST_GeomFromText('POINT(-72.23953432795741 -39.29436198328951)', 4326));
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Carmen Herrera', 'carmen.herrera@example.com', 'pass1234', '20345678-0',ST_GeomFromText('POINT(-72.23939122721433 -39.29418905819766)', 4326));
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Fernando Mora', 'fernando.mora@example.com', 'pass5678', '23456789-1',ST_GeomFromText('POINT(-70.94343055289791 -53.161673785843504)', 4326));--PUNTA ARENAS
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Gabriela Castillo', 'gabriela.castillo@example.com', 'pass91011', '21567890-2',ST_GeomFromText('POINT(-70.94572199434975 -53.160851706087755)', 4326));
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Mauricio Pinto', 'mauricio.pinto@example.com', 'pass1213', '22678901-3',ST_GeomFromText('POINT(-70.31368820371438 -27.3590183560186)', 4326));--COPIAPÓ
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Lucia Méndez', 'lucia.mendez@example.com', 'pass1415', '22789012-4',ST_GeomFromText('POINT(-70.31283756029991 -27.35836069846974)', 4326));
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Carmen Rosario', 'carmen.reosario@example.com', 'pass1234', '21445678-0',ST_GeomFromText('POINT(-70.13005699582126 -20.235032129183317)', 4326));--IQUIQUE
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Fernando Martinez', 'fernando.martinez@example.com', 'pass5678', '22456789-2',ST_GeomFromText('POINT(-70.13047671112301 -20.237267679052415)', 4326));
INSERT INTO Voluntario (nombre, email, password, rut,ubicacion_voluntario) VALUES ('Gabriela Gaete', 'gabriela.gaete@example.com', 'pass91011', '20567890-2',ST_GeomFromText('POINT(-70.1310180399508 -20.236845974454152)', 4326));
